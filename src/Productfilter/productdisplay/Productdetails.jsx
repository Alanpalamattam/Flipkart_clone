      ...
      <div className="productconatiner">
        {
            ...
            <div className="productdetails-section">
              ...
              <div className="product-ratingarea">
                ...
                <div className="flip-assured">
                    <img src="https://rukminim1.flixcart.com/www/120/32/promos/25/06/2024/71af54bd-9160-41ff-81cc-c55e534dedeb.png?q=60" alt="f-assuredimage" />
                </div>
              </div>
              <div className="discoundarea">
                 <div className="discoundflexarea">
                    <div className="percentagearea">
                        <div className="percentagecontent">
                            <div className="pflexarea">
                                ...
                                <div className="percentagenumber">{p.ratingpercent}%</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="productprice">
                        <div className="productprice-content">₹{p.org_price}</div>
                    </div> 
                 </div>
              </div>
              <div className="bankofferarea">
                <div className="wowimage">
                    <img src="https://rukminim1.flixcart.com/www/38/16/promos/30/08/2023/59dc7885-72bf-4135-9099-025f074b0eb1.png?q=90" alt="wowimage" />
                </div>
                <div className="bankoffer-price"> ₹{p.bankoffer_price} </div>
                <div className="bankoffer-price2"> with Bank offer</div>
              </div>
              <div className="exchange-content">
                <div className="exchangetext1">
                    Upto
                </div>
                <div className="exchangetext2">
                    ₹220
                </div>
                <div className="exchangetext3">
                    Off on Exchange
                </div>
              </div>
              {
                p.delivery_1day==true?<div className="deliverydate">
          ...
          <div>
            <div className="favbutton">
                <div className="fav"><svg width="24" height="24" viewBox="0 0 256 256"><path fill="none" d="M0 0h256v256H0z"></path><path d="M128 216S28 160 28 92a52 52 0 0 1 100-20h0a52 52 0 0 1 100 20c0 68-100 124-100 124Z" fill="#fff" stroke="#B8BBBF" stroke-linecap="round" stroke-linejoin="round" stroke-width="12"></path></svg></div>
            </div>
          </div>
          <div className="productbottomflexarea">
            {
                p.features.map((m,index)=>{
                return <div className="productfeaturebox" key={index}>
